...
<article class="secao-artigo-unico <?php echo $class; ?>">
	...
	<!-- 6. Rodapé do Conteúdo (Tags) -->
	<footer class="secao-artigo-unico__footer">
		<?php mm_render_component( 'molecules', 'tags-artigo', $tags_args ); ?>
	</footer>

	<!-- 7. Caixa de Perfil do Autor -->
	<div class="secao-artigo-unico__author-section">
		<?php mm_render_component( 'molecules', 'autor-profile-box', $author_box_args ); ?>
	</div>
</article>
