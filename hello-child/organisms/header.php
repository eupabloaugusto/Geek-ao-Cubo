...
<header class="header js-header" role="banner">
	<div class="header__container">
		...
		<div class="header__logo">
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="header__logo-link" aria-label="<?php esc_attr_e( 'Página Inicial - Geek ao Cubo', 'hello-elementor-child' ); ?>">
				<?php 
				$logo_path = get_stylesheet_directory() . '/Novos-arquivos/Logo geek ao cubo 02.svg';
				if ( file_exists( $logo_path ) ) {
					// Injeta o SVG inline para melhor performance e controle via CSS
					echo file_get_contents( $logo_path );
				} else {
					echo '<span class="header__logo-text">' . $logo_text . '</span>';
				}
				?>
			</a>
		</div>
